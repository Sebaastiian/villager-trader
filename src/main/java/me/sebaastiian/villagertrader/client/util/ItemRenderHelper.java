...
public class ItemRenderHelper {
    ...
    public static void renderFakeItemColored(ItemStack stack, int x, int y, float red, float green, float blue,
                                             float alpha) {
        if (stack.isEmpty()) {
            return;
        }
     ...
     */
    public static void renderItemModel(ItemStack stack, int x, int y, float red, float green, float blue, float alpha,
                                       BakedModel model) {
    ...
    private static MultiBufferSource wrapBuffer(MultiBufferSource buffer, float red, float green, float blue,
                                                float alpha, boolean forceTranslucent) {
        return renderType -> new TintedVertexConsumer(buffer.getBuffer(forceTranslucent ? TRANSLUCENT : renderType),
